...
public class ChessMatch {
	...
	private ChessPiece newPiece(String type, Color color) {
		...
		else if(type.contentEquals("N")) return new Knight(board, color);
		else if(type.contentEquals("Q")) return new Queen(board, color);
